Vue.directive 'loading', (value) ->
    ...
    html = "
        <div class='highwe-loading'>
            <svg class='part l no-opacity' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' width='50px' height='50px' viewBox='0 0 100 100' enable-background='new 0 0 100 100' xml:space='preserve'>
                <g>
            ...
            <svg version='1.1' class='part r no-opacity' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px'width='50px' height='50px' viewBox='0 0 100 100' enable-background='new 0 0 100 100' xml:space='preserve'>
                <g>

...
class BaseHandler(RequestHandler):
    ...
    def render_module_string(self, template_name, **kwargs):
        '''
        create by bigzhu at 15/07/02 15:41:14 暴露真正的 render_string 方法, 路径加上 ui_module
        '''
        template_name = 'ui_module/' + template_name
